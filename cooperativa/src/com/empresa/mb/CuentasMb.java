...
public class CuentasMb {
	...
	private Persona afiliadosSeleccionado;
	...
	@PostConstruct
	public void init() {
		afiliadosSeleccionado = new Persona();
	...
	public Persona getAfiliadosSeleccionado() {
		return afiliadosSeleccionado;
	}
	...
	public void setAfiliadosSeleccionado(Persona afiliadosSeleccionado) {
		this.afiliadosSeleccionado = afiliadosSeleccionado;
	}
